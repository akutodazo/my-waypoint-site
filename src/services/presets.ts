...
export const FLIGHT_PRESETS: FlightPreset[] = [
  {
    ...
    height: 20, gimbalPitch: -90, front: 0.8, side: 0.7, speed: 5,
  },
  {
    id: 'detail-10',
    label: '詳細 10m',
    description: '葉を目視できる詳細なオルソ画像用',
    height: 10, gimbalPitch: -90, front: 0.8, side: 0.7, speed: 5,
  },
  {
    id: 'oblique-10',
    label: '斜め撮影 10m',
    description: '3D化（SfM）の精度を上げる斜め撮影用',
    height: 10, gimbalPitch: -60, front: 0.8, side: 0.7, speed: 5,
  },
];
